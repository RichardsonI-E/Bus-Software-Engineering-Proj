...
public class JsonUtilities {
    ...
    public static void saveStations(List<Station> stations) {
        ...
        try (FileWriter writer = new FileWriter("src/test/java/json/stations.json")) {
    ...
    public static List<Station> loadStations() {
        ...
        try (FileReader reader = new FileReader("src/test/java/json/stations.json")) {
    ...
    public static void saveUsers(List<User> users) {
        ...
        try (FileWriter writer = new FileWriter("src/test/java/json/users.json")) {
    ...
    public static List<User> loadUsers() {
        ...
        try (FileReader reader = new FileReader("src/test/java/json/users.json")) {
    ...
    public static void saveBuses(List<Bus> buses) {
        ...
        try (FileWriter writer = new FileWriter("src/test/java/json/buses.json")) {
    ...
    public static List<Bus> loadBuses() {
        ...
        try (FileReader reader = new FileReader("src/test/java/json/buses.json")) {
